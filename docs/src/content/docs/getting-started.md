...
:::caution[Licence]
Anonamoose is built by [BridgePoint](https://bridgepoint.co.nz) and licensed under [Business Source License 1.1](/licence/). **Free for personal and non-commercial use.** If you or your organisation are using Anonamoose for any commercial purpose — including internal business use, offering as a hosted service, or as part of a revenue-generating product — you need a commercial licence from BridgePoint. Contact [ben@bridgepoint.co.nz](mailto:ben@bridgepoint.co.nz).
:::
